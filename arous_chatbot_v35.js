  ...
  function pageAISolutionsMenu() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        ...
        { label: '\uD83C\uDFA4 Arous Voice - AI Receptionist', action: function(){ setPage(pageAISolution('Arous Voice - AI Receptionist', 'Your AI Receptionist. Always Ready to Answer.\n\nNever miss a call. Never miss an opportunity.\n\nArous Voice answers incoming calls, responds to customer questions, captures leads, qualifies callers, and takes messages through natural conversation.\n\nCustomized for your business and designed to integrate with your existing systems, Arous Voice helps turn unanswered calls into business opportunities.')); } },
