(function () {
  ...
  style.textContent = `
    #evie-bubble {
      ...
      border: none; background: #b51a00; cursor: pointer; z-index: 999999;
    ...
    #evie-window {
      ...
      border-radius: 16px; background: #1a0a00; border: 1px solid rgba(255,171,1,0.2);
    ...
    #evie-avatar {
      ...
      background: rgba(255,171,1,0.2); border: 2px solid #ffab01;
    ...
    #evie-input-area { padding: 12px; border-top: 1px solid rgba(255,171,1,.1); display: flex; gap: 8px; flex-shrink: 0; }
    #evie-input {
      flex: 1; background: rgba(255,255,255,.06); border: 1px solid rgba(255,171,1,.2);
      border-radius: 10px; padding: 10px 12px; color: #fff; resize: none;
      outline: none; font-size: 16px; font-family: inherit;
    }
    #evie-input:focus { border-color: #ffab01; }
    #evie-send {
    ...
    .evie-bot {
      background: rgba(255,171,1,.08); color: rgba(255,255,255,.9);
      align-self: flex-start; border-radius: 4px 14px 14px 14px; border-left: 3px solid #ffab01;
    }
    .evie-user {
      background: linear-gradient(135deg, #b51a00, #7a1000);
      color: #fff; align-self: flex-end; border-radius: 14px 4px 14px 14px;
    }
    .evie-bot a { color: #ffab01; text-decoration: underline; }
    .evie-btn {
      background: transparent; border: 1px solid rgba(255,171,1,.4); color: #ffab01;
    ...
    .evie-btn:hover { background: rgba(255,171,1,.1); border-color: #ffab01; }
    .evie-buttons { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 4px; }

    @keyframes evieBrainPulse {
      0%, 100% { transform: scale(1); filter: drop-shadow(0 0 4px #ffab01); }
      50% { transform: scale(1.15); filter: drop-shadow(0 0 10px #ffab01); }
    }
  ...
  bubble.innerHTML = '<img src="https://birthingbycalm.com/wp-content/uploads/2025/07/logo-brown.png" style="width:52px;height:52px;object-fit:contain;border-radius:50%;">';
  ...
  async function sendMessage() {
    ...
    thinking.innerHTML = '<span style="font-size:22px;animation:evieBrainPulse 1.2s ease-in-out infinite;filter:drop-shadow(0 0 6px #ffab01)">🧠</span><span style="font-size:12px;color:#ffab01;animation:evieFadeInOut 1.2s ease-in-out infinite">Evie is thinking...</span>';
  ...
  var buttons = [
    ...
    { label: '📞 Contact Us', msg: 'I would like to get in touch with someone' },
    { label: '🎁 Current Promotions', msg: 'Do you have any current promotions?' },
  ];
