(function () {
  ...
  style.textContent = `
    ...
    .evie-btn:hover { background: rgba(158,58,38,.1); border-color: #9E3A26; }
    .evie-buttons { display: flex; flex-wrap: wrap; gap: 6px; margin-top: 4px; }
    .evie-buttons-stack { display: flex; flex-direction: column; gap: 8px; margin-top: 4px; width: 100%; }
    ...
    .evie-register-btn {
      ...
      background: linear-gradient(135deg, #9E3A26, #b51a00); color: #fff;
  ...
  function showMainMenu() {
    addButtons([
      { label: '🌸 View Services',       action: showServiceCategories },
  ...
  function showServiceCategories() {
    ...
    addStackedButtons([
      ...
      { label: '⬅ Back to Main Menu',     action: showMainMenu },
    ]);
  }
  ...
  function showHypnoBirthing() {
    ...
    addButtons([
      ...
      { label: '⬅ Back',             action: showServiceCategories },
  ...
  function showCompleteClass() {
    ...
    addButtons([
      { label: '⬅ Back to Classes', action: showHypnoBirthing },
      { label: '🏠 Main Menu',       action: showMainMenu },
    ]);
  }
