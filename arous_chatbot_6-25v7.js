(function () {
  ...
  function pageMainMenu() {
    return function(p) {
      p.appendChild(btnStack([
        ...
        { label: '\u{1F4A1} Business Challenges', action: function(){ setPage(pageBizChallenges()); } },
        { label: '\u{1F4AC} Talk to Daniel',      action: function(){ setPage(pageTalkToDaniel()); } },
      ]));
    };
  }
  ...
  function pageAssessmentMenu() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        { label: '\u{1F50D} Lost Opportunities Assessment', msg: 'I would like to schedule a Lost Opportunities Assessment', fromButton: true },
        { label: '\u{1F4CA} Business Operations Assessment', msg: 'I would like to schedule a Business Operations Assessment', fromButton: true },
      ]));
  ...
  function pageLostOpportunities() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        { label: '\u{1F4C5} Schedule This Assessment', msg: 'I would like to schedule a Lost Opportunities Assessment', fromButton: true },
      ]));
      p.appendChild(navRow([
  ...
  function pageBusinessOperations() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        { label: '\u{1F4C5} Schedule This Assessment', msg: 'I would like to schedule a Business Operations Assessment', fromButton: true },
      ]));
      p.appendChild(navRow([
        { label: '\u2B05 Services',   action: function(){ setPage(pageServicesMenu()); } },
        { label: '\u{1F3E0} Main Menu', action: function(){ setPage(pageMainMenu()); } },
  ...
  function pageAIConcierge() {
    return function(p) {
      ...
      p.appendChild(navRow([
        { label: '\u{1F4AC} Talk to Daniel', action: function(){ setPage(pageTalkToDaniel({ label: '\u2B05 Services', action: function(){ setPage(pageServicesMenu()); } })); } },
        { label: '\u2B05 Services',          action: function(){ setPage(pageServicesMenu()); } },
        { label: '\u{1F3E0} Main Menu',      action: function(){ setPage(pageMainMenu()); } },
      ]));
    };
  ...
  function pageAISolution(name, body) {
    return function(p) {
      ...
      p.appendChild(navRow([
        { label: '\u{1F4AC} Talk to Daniel', action: function(){ setPage(pageTalkToDaniel({ label: '\u2B05 AI Solutions', action: function(){ setPage(pageAISolutionsMenu()); } })); } },
