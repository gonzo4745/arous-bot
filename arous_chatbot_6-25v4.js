(function () {
  ...
  function clearPanel() {
    // Hard clear — removes all children individually to avoid innerHTML pitfalls
    while (menuPanel.firstChild) menuPanel.removeChild(menuPanel.firstChild);
    // Re-anchor panel at end of M if it was displaced
    if (menuPanel.parentNode !== M) M.appendChild(menuPanel);
  }
