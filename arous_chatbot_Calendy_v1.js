(function () {
  ...
  function pageAssessmentMenu() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        { label: '🔍 Lost Opportunities Assessment', action: function(){ window.open('https://calendly.com/hello-arous/30min', '_blank'); } },
        { label: '📊 Business Operations Assessment', action: function(){ window.open('https://calendly.com/hello-arous/30min', '_blank'); } },
      ]));
  ...
  function pageLostOpportunities() {
    return function(p) {
      ...
      p.appendChild(btnStack([
        { label: '📅 Schedule This Assessment', action: function(){ window.open('https://calendly.com/hello-arous/30min', '_blank'); } },
      ]));
      p.appendChild(navRow([
        { label: '\u2B05 Services',   action: function(){ setPage(pageServicesMenu()); } },
        { label: '🏠 Main Menu', action: function(){ setPage(pageMainMenu()); } },
