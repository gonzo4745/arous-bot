(function () {
  ...
  style.textContent = `
    ...
    .evie-back-btn { background: transparent; border: 1px solid rgba(255,255,255,.2); color: rgba(255,255,255,.5);
      border-radius: 8px; padding: 5px 10px; cursor: pointer; font-size: 11px;
      transition: background .2s, color .2s; white-space: nowrap; }
    .evie-back-btn:hover { background: rgba(255,255,255,.08); color: rgba(255,255,255,.8); }
