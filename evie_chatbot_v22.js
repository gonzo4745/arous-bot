...
// evie_chatbot_v22.js
// v22 — 2026-07-17
// Changes from v21: The metrodetroithypnosis.com link (in the Private
// Hypnosis Services message) now renders in #689F38 (green). This is a
// targeted override — every other auto-linked URL and phone number in
// bot messages keeps the default link color. No other menus, flows, or
// logic changed.
...
(function () {
  ...
  function renderText(t) {
    ...
    // Special-case color override for the Metro Detroit Hypnosis link only —
    // every other auto-linked URL/phone number keeps the default link color.
    s = s.replace(
