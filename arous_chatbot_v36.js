...
(function () {
  ...
  var faqAnswers = {
    ...
    'what_types': 'Arous AI works with businesses of different sizes — from local service providers to growing organizations — locally across Middle Tennessee and remotely nationwide.\n\nService-based businesses such as HVAC, plumbing, electrical, roofing, landscaping, salons, spas, chiropractors, and veterinary practices often start with a Lost Opportunities Assessment, which focuses on customer responsiveness, lead capture, communication, and day-to-day operations.\n\nMid-size businesses and leadership teams evaluating operational efficiency, business processes, technology, and how AI can support business goals are typically a fit for a Business Operations Assessment, which includes an AI Readiness Evaluation.',
    'software': 'Not always. Every engagement starts with understanding how your business actually operates — where the gaps are and what will make a real difference. Sometimes that is AI. Sometimes it is not.\n\nMany businesses already have tools in place but aren\'t using them efficiently, so we focus on improving your existing processes and technology wherever possible rather than recommending software you may not need.',
