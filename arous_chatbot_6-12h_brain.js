(function () {
  ...
  function showAssessmentMenu() {
    ...
    addMsg("Which assessment are you interested in?", 'bot');

    var btnStack = document.createElement('div');
    btnStack.className = 'arous-btn-stack';

    var assessments = [
      { label: '🔍 Operational Assessment', msg: 'I would like to schedule an Operational Assessment' },
      { label: '🤖 AI Readiness Assessment', msg: 'I would like to schedule an AI Readiness Assessment' },
    ];
