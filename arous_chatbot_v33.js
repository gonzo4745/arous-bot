// arous_chatbot_v33.js
// v33 — 2026-07-15
// Changes from v32:
// 1. Moved "❓ FAQs" from the top-level main menu into the Services submenu
//    (last item in the Services button stack). FAQs page's back-navigation
//    now goes to Services instead of straight to Main Menu.
// 2. Moved "Who We Help" and "What We Do" off the top-level main menu.
//    "About Arous" now shows its canned response plus Who We Help / What We
//    Do as sub-buttons; those two subpages get a new "⬅ About Arous" back
//    link. Main menu is now 6 items: About Arous, Complimentary Assessments,
//    Training, Daniel in Under a Minute, Services, Talk to Daniel.
